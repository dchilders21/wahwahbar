...
[Product Name: {{ BRIAN_IMPORTANT_TEST_BIDDING_DO_NOT_DELETE - Banner - MP }} ]
[Site Name: {{ BRIAN_IMPORTANT_TEST_BIDDING_DO_NOT_DELETE - Banner - MP }} ]
[Product id: {{ 876 }} ]
[Widget id: {{ 10523 }} ]

Published on:  2016-06-20 14:41:45 EST
*/
...
var wahwah = {
    ...
    environment: "prod",
    id: widgetID,
	demandSourceListUrl: "http://test.wahwahnetworks.com/brian/tb4/tags/demand/yellowhammer.biddingsources.json.txt",
    position: "bottom",
    lan: "EN",
    skin: "default",
    app: "adOnly",
    ...
    adconfig: {
        "inpage": {
            ...
            "freqCap": false,
            "freqNum": 2,
            "combinedDisplayURL": "ww-openx:auid=538488991;",
            "combinedDisplayLBURL": "",
            "displayURL": "ww-openx:auid=538488992;",
            "displayLBURL": "",
            "mobile320URL": "ww-openx:auid=538488995;",
            "mobile728URL": "ww-openx:auid=538488994;",
            "leaveBehindAdURL": "ww-openx:auid=538488996;",
            "adFormat": "banner",
            ...
            "vidURL": "http://ox-d.wahwahnetworks.com/v/1.0/av?auid=538488993",
