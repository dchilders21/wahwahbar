...
package {
    ...
    public class ExampleVPAID extends Sprite implements IVPAID {
        ...
        public function get adVolume():Number {
			var vol = 1.0;
			log("adVolume being checked by player. Returning: "+vol);
            return vol;
        }
        ...
        public function set adVolume(value:Number):void {
			log("set adVolume("+value+") called by player. ignored by ad: ");
        }
		...
		public function _log(mesg:String):void {
            log(mesg);            
        }
        ...
        public function initAd(initWidth:Number, initHeight:Number, viewMode:String, desiredBitrate:Number, 
            ...
            // set the duration of your VPAID ad. creativeData comes from AdParameters
        ...
        */
        ...
        protected function positionFakeAd():void {
            if (fakeAd) {
                fakeAd.width = initWidth; 
                fakeAd.height = initHeight;
                fakeAd.x = 0;
                fakeAd.y =  0;
            }
        }
